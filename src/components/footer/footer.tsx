  ...
  return (
    <footer className="site-footer-one">
            ...
            <div className="footer-widget footer-widget__social__widget">
              <div className="footer-widget__inner">
                ...
                <div className="footer-widget__social">
                  <a href={CONTACT_INFO.SOCIAL_MEDIA.FACEBOOK}>
                    <i className="fab fa-facebook-square"></i>
                  </a>
                  <a href={CONTACT_INFO.SOCIAL_MEDIA.INSTAGRAM}>
                    <i className="fab fa-instagram"></i>
                  </a>
                  <a href={CONTACT_INFO.SOCIAL_MEDIA.TRIPADVISOR}>
                    <i className="fab fa-tripadvisor"></i>
                  </a>
                  <a href={CONTACT_INFO.SOCIAL_MEDIA.WHATSAPP}>
      ...
      <div className="footer-powered-by">
        ...
        >
          <img
            src="/assets/images/logo-makers.png"
            alt="Logo Makers"
            className="footer-makers-logo"
          />
        </a>
      </div>
    </footer>
