            ...
            <div className="topbar-one">
                <div className="container">
                    ...
                    <div className="topbar-one__social">
                        <a href={CONTACT_INFO.SOCIAL_MEDIA.FACEBOOK} target="_blank" rel="noopener noreferrer"><Facebook className="w-5 h-5" /></a>
                        <a href={CONTACT_INFO.SOCIAL_MEDIA.TRIPADVISOR} target="_blank" rel="noopener noreferrer"><Twitter className="w-5 h-5" /></a>
                        <a href={CONTACT_INFO.SOCIAL_MEDIA.FLICKR} target="_blank" rel="noopener noreferrer"><Share2 className="w-5 h-5" /></a>
                        <a href={CONTACT_INFO.SOCIAL_MEDIA.INSTAGRAM} target="_blank" rel="noopener noreferrer"><Instagram className="w-5 h-5" /></a>
                    </div>
                </div>
            </div>
                        ...
                        <div className="main-nav__main-navigation">
                            <ul className="main-nav__navigation-box">
                                <li className="dropdown">
                                    <Link 
                                        href={ROUTES.HOME} 
                                        className={`transition-colors duration-200 hover:text-blue-500 ${isActive(ROUTES.HOME)}`}
                                    >
                                        Inicio
                                    </Link>
                                </li>
                                <li className="dropdown">
                                    <Link 
                                        href={ROUTES.ABOUT} 
                                        className={`transition-colors duration-200 hover:text-blue-500 ${isActive(ROUTES.ABOUT)}`}
                                    >
                                        Nosotros
                                    </Link>
                                </li>
                                ...
                                <li className="dropdown">
                                    <Link 
                                        href={ROUTES.COURSES} 
                                        className={`transition-colors duration-200 hover:text-blue-500 ${isActive(ROUTES.COURSES)}`}
                                    >
                                        Cursos
                                    </Link>
                                </li>
                                ...
                                <li className="dropdown">
                                    <Link 
                                        href={ROUTES.CONTACT} 
                                        className={`transition-colors duration-200 hover:text-blue-500 ${isActive(ROUTES.CONTACT)}`}
                                    >
                                        Contactos
                                    </Link>
                                </li>
